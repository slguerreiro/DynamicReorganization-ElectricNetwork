//Source file: C:/Meic/Tese/VigilanciaRoboticoCaseStudy/Codigo/Simulator/RiskMappings.java
 ...
 * @version
 */
public class RiskMappings extends Repository
{
   ...
   */
   ...
   public RiskMappings()
   {
      ...
      Ficheiro = new String(Constants.pathInputFile + Constants.RskMs);

      System.out.println("\t\tRisksMappings created...(DATA)");
      WriteFile.Writeln("\t\tRisksMappings created...(DATA)",Constants.pathOutputFile,Constants.OutputFile);
   ...
   public DataType Read()
   {
    try
    {
      ...
      else
      {
        ...
        return  ( new RskData( line.substring(0,a) ,
